...
export default function FlavoursEdit(props) {
    ...
    const Submit = () => {
        ...
        Axios.post(
            `https://sweede.app/AdminPanel/register/update-Flavours/${Flavour.id}`,
            formdata,
            config,
                                    ...
                                    <div className='col'>
                                        {
                                            image ? <> <img src={URL.createObjectURL(image)} alt="" style={{ width: "120px", height: "110px" }} />
                                                ...
                                                :
                                                <>
                                                    <img src={"http://backend.sweede.net/" + Flavour.FlavoursImage} alt="" style={{ width: "120px", height: "110px" }} />
