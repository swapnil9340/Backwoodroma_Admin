            ...
            {RolePermissionArray?.map((items,index)=>{
                return(
                    ...
                    <div className="col-10">
                        ...
                        {items.editSite&&(
                            <div className="col-12"><p><span><IconButton  size="small"><HiExclamationCircle  color="orange" size={18}/></IconButton></span>This permission is required because <span>{items.editSite}</span> is turned on.</p>
                        </div>
                        )}
